...
pygame.mixer.music.load(os.path.join('sounds', 'track.mp3'))

user_dim = pygame.display.list_modes()[0][1] // 600
SCREEN_DIM = (user_dim*800, user_dim*600)
...
def create_game(sprite_size, is_new):
    ...
    if is_new:
        ...
        drawer = SE.GameSurface((user_dim*640, user_dim*480), pygame.SRCALPHA, (0, user_dim*480),
                                SE.ProgressBar((user_dim*640, user_dim*120), (user_dim*640, 0),
                                                SE.InfoWindow((user_dim*160, user_dim*600), (user_dim*50, user_dim*50),
                                                                SE.HelpWindow((user_dim*700, user_dim*500), pygame.SRCALPHA, (0, 0),
                                                                            SE.ScreenHandle(
                                                                                (0, 0))
                                                                            ))))
